...
const Form1 = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className="md:m-12 m-6 justify-items-center grid grid-cols-1 md:grid-cols-2 ">


                <div className="image-container mt-5 mb-2 " style={{ position: "relative" }}>
                    ...
                    <div className={styles.imageContainer}>
                        ...
                        {/* <div className="flex mt-5 items-center justify-center mr-5">
                            <img className={`mt-1 ${styles.nameLogo}`} src="/Images/contact-us/email.svg" alt="Email" />
                            <a style={{ color: "#2F2211" }} className="ml-2 underline" href="mailto:info@scottishhindufoundation.com" target="_blank" rel="noopener noreferrer">info@scottishhindufoundation.com</a>
                        </div> */}
                    </div>
                </div>
